...
class PanelSettings:
    ...
    # This RG2 model uses prismatic finger joints in meters, not revolute joints in radians.
    gripper_open_rad: float = 0.04
    ...
    def from_env(cls) -> "PanelSettings":
        ...
        settings = cls(
            ...
            gripper_open_rad=_env_float("PANEL_GRIPPER_OPEN_RAD", 0.04),
