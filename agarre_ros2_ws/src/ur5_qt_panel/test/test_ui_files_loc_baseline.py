...
LOC_BASELINE = {
    ...
    "panel_utils.py": 1040,  # 2026-05-09 post-merge: +6 LOC del trabajo TFM ML en main.
    ...
    "panel_ros.py": 2214,  # 2026-05-09 post-merge: +56 LOC del trabajo TFM ML en main.
    # 2026-05-09: panel_pick_object.py BORRADO (path MoveIt-classic eliminado).
    "panel_v2.py": 1254,  # 2026-05-09 post-merge: +2 LOC del trabajo TFM ML en main.
}
