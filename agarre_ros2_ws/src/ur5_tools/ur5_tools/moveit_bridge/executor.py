...
class ExecutorMixin:
    ...
    # F5-iter4 audit-v4.1 (2026-05-08): _setup_post_accept_state /
    # _send_and_accept_fjt_goal / _prepare_fjt_execution movidos a
    # ``moveit_bridge.fjt_lifecycle_mixin.FjtLifecycleMixin`` para
    # cerrar el scaffold inacabado (executor.py +117 LOC declarado en
    # f645c44). UR5MoveItBridge hereda ahora también del nuevo mixin.
