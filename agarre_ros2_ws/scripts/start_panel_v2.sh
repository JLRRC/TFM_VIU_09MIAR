...
export PANEL_PICK_OBJECT_GRASP_JOINT_FALLBACK="${PANEL_PICK_OBJECT_GRASP_JOINT_FALLBACK:-1}"
...
export PANEL_PICK_OBJECT_OBJECT_XY_GATE_TOL_M="${PANEL_PICK_OBJECT_OBJECT_XY_GATE_TOL_M:-0.350}"
export PANEL_PICK_OBJECT_TCP_OBJ_DIST_MAX_M="${PANEL_PICK_OBJECT_TCP_OBJ_DIST_MAX_M:-0.400}"
...
export PANEL_PICK_OBJECT_GRASP_CARTESIAN="${PANEL_PICK_OBJECT_GRASP_CARTESIAN:-1}"
export PANEL_PICK_OBJECT_LIFT_CARTESIAN="${PANEL_PICK_OBJECT_LIFT_CARTESIAN:-1}"
...
export PANEL_MOVEIT_BRIDGE_CONTROLLER_GOAL_TIME_TOL_SEC="${PANEL_MOVEIT_BRIDGE_CONTROLLER_GOAL_TIME_TOL_SEC:-30.0}"
export PANEL_MOVEIT_BRIDGE_CONTROLLER_EXPECTED_GOAL_TIME_SEC="${PANEL_MOVEIT_BRIDGE_CONTROLLER_EXPECTED_GOAL_TIME_SEC:-30.0}"
