...
export PANEL_PICK_OBJECT_DETERMINISTIC_JOINT_AFTER_APPROACH="${PANEL_PICK_OBJECT_DETERMINISTIC_JOINT_AFTER_APPROACH:-1}"
...
export PANEL_PICK_OBJECT_GRASP_Z_REACH_TOL_FALLBACK_M="${PANEL_PICK_OBJECT_GRASP_Z_REACH_TOL_FALLBACK_M:-0.130}"
export PANEL_PICK_OBJECT_GRASP_STEP_TOL_M="${PANEL_PICK_OBJECT_GRASP_STEP_TOL_M:-0.040}"
export PANEL_PICK_OBJECT_OBJECT_XY_GATE_TOL_M="${PANEL_PICK_OBJECT_OBJECT_XY_GATE_TOL_M:-0.220}"
export PANEL_PICK_OBJECT_TCP_OBJ_DIST_MAX_M="${PANEL_PICK_OBJECT_TCP_OBJ_DIST_MAX_M:-0.260}"
