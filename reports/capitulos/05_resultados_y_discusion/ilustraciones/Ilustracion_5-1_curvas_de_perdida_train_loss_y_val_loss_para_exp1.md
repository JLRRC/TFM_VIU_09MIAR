...
- Titulo: Curvas de perdida (train_loss y val_loss) para EXP1
...
- Nota: El fichero fuente historico estaba numerado como 5_2; aqui se reordena segun la numeracion real del PDF.
- Ficheros asociados:
