...
| `EXP3_RESNET18_RGB_AUGMENT` | `ResNet18Grasp` | `ResNetGrasp` | RGB | 3 | True | moderate_strong | 50 | `smooth_l1` | `agarre_inteligente/config/exp3_resnet18_rgb_augment.yaml` | 3 | `agarre_inteligente/experiments/EXP3_RESNET18_RGB_AUGMENT/best_epoch_summary.csv` | principal |
...
| `EXP_METHOD_V2_RGB` | `SimpleGraspCNN` | `SimpleCNN` | RGB | 3 | False | -- | 10 | `grasp_loss` | `agarre_inteligente/config/exp_methodology_v2.yaml` | 0 | no localizado | metodologia pendiente |
