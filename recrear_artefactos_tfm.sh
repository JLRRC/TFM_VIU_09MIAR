...
mkdir -p "$LOSS_TMP" "$BOUNDARY_TMP" "$ROOT/report/figures/cap5" "$ROOT/report/evidence/chapter5"
...
cp -a "$LOSS_TMP/ilustracion_5_2_curvas_loss_exp1_simple_rgb.png" \
  "$ROOT/report/figures/cap5/Ilustracion_5-1_curvas_de_perdida_train_loss_y_val_loss_para_exp1.png"
cp -a "$LOSS_TMP/ilustracion_5_3_curvas_loss_exp2_simple_rgbd.png" \
  "$ROOT/report/figures/cap5/Ilustracion_5-2_curvas_de_perdida_train_loss_y_val_loss_para_exp2.png"
cp -a "$LOSS_TMP/ilustracion_5_4_curvas_loss_exp3_resnet18_rgb_augment.png" \
  "$ROOT/report/figures/cap5/Ilustracion_5-3_curvas_de_perdida_train_loss_y_val_loss_para_exp3.png"
cp -a "$LOSS_TMP/ilustracion_5_5_curvas_loss_exp4_resnet18_rgbd.png" \
  "$ROOT/report/figures/cap5/Ilustracion_5-4_curvas_de_perdida_train_loss_y_val_loss_para_exp4.png"
...
cp -a "$BOUNDARY_TMP/fig_5_15_false_negative_plausible.png" \
  "$ROOT/report/figures/cap5/Ilustracion_5-15_caso_limite_de_falso_negativo_visualmente_plausible.png"
cp -a "$BOUNDARY_TMP/fig_5_15_false_negative_plausible.pdf" \
  "$ROOT/report/figures/cap5/Ilustracion_5-15_caso_limite_de_falso_negativo_visualmente_plausible.pdf"
cp -a "$BOUNDARY_TMP/fig_5_15_false_negative_plausible.png" \
  "$ROOT/report/evidence/chapter5/fig_5_15_false_negative_plausible.png"
cp -a "$BOUNDARY_TMP/fig_5_15_false_negative_plausible.pdf" \
  "$ROOT/report/evidence/chapter5/fig_5_15_false_negative_plausible.pdf"
cp -a "$BOUNDARY_TMP/fig_5_15_false_negative_plausible_candidates.csv" \
  "$ROOT/report/evidence/chapter5/fig_5_15_false_negative_plausible_candidates.csv"

"$PYTHON_BIN" "$ROOT/agarre_inteligente/scripts/regenerate_chapter5_post_retrain.py"

echo "Artefactos regenerados en report/figures/cap5 y report/evidence/chapter5."
