...
- `agarre_ros2_ws/src/ur5_bringup/config/runtime_defaults.yaml`
- `agarre_ros2_ws/src/ur5_qt_panel/ur5_qt_panel/panel_pick_demo_params.py`
...
- `auditoria/directo_debug_transport_final_20260423_1/stack.log`
...
| `evidence_logger` | `agarre_ros2_ws/src/ur5_tools/setup.py` | Entry point Python: ur5_tools.evidence_logger:main |
...
| `plan_to_pose_server` | `agarre_ros2_ws/src/ur5_tools/setup.py` | Entry point Python: ur5_tools.plan_to_pose_server:main |
...
| `tf_geometry_service` | `agarre_ros2_ws/src/ur5_tools/setup.py` | Entry point Python: ur5_tools.tf_geometry_service:main |
| `object_pose_resolver_service` | `agarre_ros2_ws/src/ur5_tools/setup.py` | Entry point Python: ur5_tools.object_pose_resolver_service:main |
| `cycle_timing` | `agarre_ros2_ws/src/ur5_tools/setup.py` | Entry point Python: ur5_tools.cli_cycle_timing:main |
| `cycle_timing_aggregator` | `agarre_ros2_ws/src/ur5_tools/setup.py` | Entry point Python:  |
...
| `grasp_selector_node` | `agarre_ros2_ws/src/tfm_grasping/setup.py` | Entry point Python: tfm_grasping.grasp_selector_node:main |
...
| `tool0` | TCP semántico del brazo | `wrist_3_link` | SDF visual actual: 0 0 0 -1.570796325 0 0 | Padre semántico de RG2 y ancla de offset del gripper | Confundir tool0 con el punto real de grasp desplaza el contacto 175 mm. |
...
| `camera_wrist_link` | frame SDF fijo | `rg2_hand` | actual confirmado en SDF: 0 0.04 0.01 0 0 0 | Cámara montada en la muñeca/gripper | Es geometría SDF, no el TCP operacional. |
| `pick_demo_anchor` | frame SDF fijo / runtime rewrite | `tool0` | SDF fuente=0 0 0.175 0 0 0; runtime actual sincronizado con la geometría canónica (`rg2_tcp`=0.175) | Ancla auxiliar para attach backend / probes | Si el runtime deja de sincronizarse con el URDF, el ancla vuelve a desviarse de rg2_pinch_center. |
...
| SDF ur5_hand_joint | actual confirmado: relative_to=tool0, pose=0 0 0 0 0 0 | memorias previas con otros valores | Priorizar el source tree actual; los valores previos quedan como históricos o desactualizados. |
| pick_demo_anchor | actual runtime efectivo: 0.175 m | histórico documentado: 0.175 m | El launch ahora sincroniza `pick_demo_anchor` directamente con la geometría canónica del URDF; ya no depende de `gripper_tcp_z_offset`. |

### 4.3 Observaciones obligatorias preservadas y reforzadas

- `tool0` vs `rg2_pinch_center`: el offset semántico actual confirmado sigue siendo 0 0 0.175. La geometría visual SDF del gripper se modela por `ur5_hand_joint=0 0 0 0 0 0` y no debe confundirse con el TCP semántico.
...
|---|---|---|
| Apertura máxima por finger | 0.0425 rad | agarre_ros2_ws/models/ur5_rg2/model.sdf |
...
| Masa cuerpo RG2 (rg2_hand) | 0.30 | agarre_ros2_ws/models/ur5_rg2/model.sdf |
| tool0 -> rg2_pinch_center | 0 0 0.175 | agarre_ros2_ws/src/ur5_description/urdf/ur5.urdf.xacro |
| Pose visual ur5_hand_joint | relative_to=tool0, pose=0 0 0 0 0 0 | agarre_ros2_ws/models/ur5_rg2/model.sdf |
| Finger izquierdo respecto a rg2_hand | 0 0.020 0 0 0 0 | agarre_ros2_ws/models/ur5_rg2/model.sdf |
| Finger derecho respecto a rg2_hand | 0 -0.020 0 0 0 0 | agarre_ros2_ws/models/ur5_rg2/model.sdf |
...
- Criterio de éxito: _validate_demo_carry(post_grasp_lift) con timeout=legacy refactorizados, min_obj_move=legacy refactorizado m, min_lift_delta=legacy refactorizado m y max_tcp_dist=legacy refactorizado m.
...
- Criterio de éxito: _validate_demo_carry(home_with_object) con timeout=legacy refactorizados, min_obj_move=legacy refactorizado m, min_lift_delta=legacy refactorizado m y max_tcp_dist default=0.2 m.
...
|---|---|---|---|---|---|
| PANEL_PICK_DEMO_ALIGN_EXIT_XY_TOL_M | - | 0.020 | - | 0.010 | discrepancia abierta |
| PANEL_PICK_DEMO_ALIGN_IK_ERR_TOL | - | 0.200 | - | 0.08 | discrepancia abierta |
| PANEL_PICK_DEMO_GRASP_DOWN_IK_ERR_TOL | - | 0.200 | - | - | override runtime activo |
| PANEL_PICK_DEMO_GRASP_DOWN_IK_SEED_WEIGHT | - | 0.035 | - | 0.65 | discrepancia abierta |
| PANEL_PICK_DEMO_GRASP_DOWN_STRICT_DIST_TOL_M | - | 0.025 | - | 0.012 | discrepancia abierta |
| PANEL_PICK_DEMO_GRASP_DOWN_STRICT_Z_TOL_M | - | 0.025 | - | 0.008 | discrepancia abierta |
| PANEL_PICK_DEMO_PRE_CLOSE_XY_TOL_M | - | 0.016 | - | 0.010 | discrepancia abierta |
...
| ATTACH_BACKEND_FOLLOW_BREAK_DIST_M | - | 0.45 | - | - | override runtime activo |
| ATTACH_BACKEND_FOLLOW_RATE_HZ | - | 10.0 | - | - | override runtime activo |
| ATTACH_BACKEND_MAX_DIST_M | - | 0.06 | - | 0.06 | override runtime activo |
| ATTACH_BACKEND_MAX_POSE_AGE_SEC | - | 2.5 | - | - | override runtime activo |
| ATTACH_BACKEND_MODE | - | follow_tcp | - | - | override runtime activo |
| PANEL_PICK_DEMO_ATTACH_FOLLOW_MAX_TCP_DIST_M | - | 0.080 | - | 0.040 | discrepancia abierta |
| PANEL_PICK_DEMO_ATTACH_MAX_REL_DRIFT_M | - | 0.050 | - | 0.012 | discrepancia abierta |
| PANEL_PICK_DEMO_ATTACH_MIN_STABLE_SAMPLES | - | 3 | - | 5 | discrepancia abierta |
| PANEL_PICK_DEMO_ATTACH_STABLE_WINDOW_SEC | - | 0.25 | - | 0.35 | discrepancia abierta |
| PANEL_PICK_DEMO_ATTACH_XY_TOL_M | - | 0.020 | - | 0.008 | discrepancia abierta |
| PANEL_PICK_DEMO_CARRY_HOME_MAX_TCP_DIST_M | - | 0.500 | - | - | override runtime activo |
| PANEL_PICK_DEMO_CLOSE_CONFIRM_TIMEOUT_SEC | - | 120 | - | 3.0 | discrepancia abierta |
...
| PANEL_PICK_DEMO_POSE_SOURCE_AGE_TOL_SEC | - | 300.0 | - | 0.400 | discrepancia abierta |
| PANEL_PICK_DEMO_POSE_SOURCE_TOL_M | - | 1.0 | - | 0.006 | discrepancia abierta |
...
| PANEL_PICK_DEMO_TRANSPORT_POSTCHECK_MODEL_TOL_M | - | 0.120 | - | - | override runtime activo |
| PANEL_PICK_DEMO_TRANSPORT_PREEXEC_MODEL_TOL_M | - | 0.020 | - | - | override runtime activo |
...
| SYSTEM_STATE_GEOMETRY_OFFSET_TOL_M | - | 0.002 | - | - | override runtime activo |
| SYSTEM_STATE_GEOMETRY_PAIR_TOL_M | - | 0.001 | - | - | override runtime activo |
| SYSTEM_STATE_STARTUP_TIMEOUT_SEC | - | 15.0 | - | - | override runtime activo |
...
| PANEL_PICK_DEMO_ALIGN_EXIT_XY_TOL_M | GRASP_ALIGN_IK | - | 0.020 | - | 0.010 | histórico=0.010 |
| PANEL_PICK_DEMO_ALIGN_IK_ERR_TOL | GRASP_ALIGN_IK | - | 0.200 | - | 0.08 | histórico=0.08 |
| PANEL_PICK_DEMO_ATTACH_FOLLOW_MAX_TCP_DIST_M | ATTACH_GATE | - | 0.080 | - | 0.040 | histórico=0.040 |
| PANEL_PICK_DEMO_ATTACH_MAX_REL_DRIFT_M | ATTACH_GATE | - | 0.050 | - | 0.012 | histórico=0.012 |
| PANEL_PICK_DEMO_ATTACH_MIN_STABLE_SAMPLES | ATTACH_GATE | - | 3 | - | 5 | histórico=5 |
| PANEL_PICK_DEMO_ATTACH_STABLE_WINDOW_SEC | ATTACH_GATE | - | 0.25 | - | 0.35 | histórico=0.35 |
| PANEL_PICK_DEMO_ATTACH_XY_TOL_M | ATTACH_GATE | - | 0.020 | - | 0.008 | histórico=0.008 |
| PANEL_PICK_DEMO_CLOSE_CONFIRM_TIMEOUT_SEC | CLOSE | - | 120 | - | 3.0 | histórico=3.0 |
| PANEL_PICK_DEMO_GRASP_DOWN_IK_SEED_WEIGHT | GRASP_DOWN | - | 0.035 | - | 0.65 | histórico=0.65 |
| PANEL_PICK_DEMO_GRASP_DOWN_KEEP_XY_TOL_M | GRASP_DOWN | - | 0.015 | - | 0.003 | histórico=0.003 |
| PANEL_PICK_DEMO_GRASP_DOWN_STRICT_DIST_TOL_M | GRASP_DOWN | - | 0.025 | - | 0.012 | histórico=0.012 |
| PANEL_PICK_DEMO_GRASP_DOWN_STRICT_Z_TOL_M | GRASP_DOWN | - | 0.025 | - | 0.008 | histórico=0.008 |
| PANEL_PICK_DEMO_POSE_SOURCE_AGE_TOL_SEC | freshness / pose source | - | 300.0 | - | 0.400 | histórico=0.400 |
| PANEL_PICK_DEMO_POSE_SOURCE_TOL_M | freshness / pose source | - | 1.0 | - | 0.006 | histórico=0.006 |
| PANEL_PICK_DEMO_PRE_CLOSE_XY_TOL_M | PRE_CLOSE | - | 0.016 | - | 0.010 | histórico=0.010 |
...
- CARRY metadata vs llamada real: metadata CARRY=(legacy refactorizado, legacy refactorizado, legacy refactorizado) frente a llamada post_grasp_lift=(legacy refactorizado, legacy refactorizado, legacy refactorizado).
...
- `follow_confirmed_only_after_carry` en fuente actual: no confirmado.
...
- `stale_tcp_pose_soft_follow` aparece cuando `tcp_age` supera `max_pose_age_sec=1.5`; los logs inspeccionados muestran separación efectiva entre ticks world_locked de 2.463 s entre dos ticks consecutivos.
...
- `best_obj_move` bajo umbral: el objeto no se movió lo suficiente desde su pose inicial. Evidencia actual: `no localizada en logs inspeccionados`.
- `best_lift_delta < 0`: el objeto cambió de pose, pero no acompañó el lift del TCP. Evidencia actual: `no localizada en logs inspeccionados`.
...
- `object_not_updated / object_never_moved`: evidencia actual `no localizada en logs inspeccionados`.

### 8.3 Discrepancias abiertas que deben quedar explícitas

- Metadata de fase CARRY: min_obj_move=legacy refactorizado, min_lift_delta=legacy refactorizado, max_tcp_dist=legacy refactorizado.
- Llamada real `_validate_demo_carry(post_grasp_lift)`: min_obj_move=legacy refactorizado, min_lift_delta=legacy refactorizado, max_tcp_dist=legacy refactorizado, timeout=legacy refactorizado.
...
| `world_locked` puede arrastrar una referencia retrasada | Objeto no sigue al TCP o queda incoherente | Demo transport usa `use_world_locked_pose=True` para `pick_demo` | Log world_locked: [gripper_attach_backend-11] [INFO] [1776911919.046005920] [gripper_attach_backend]: [ATTACH_BACKEND] demo_transport_follow_tick object=pick_demo mode=world_locked desired=(-0.414,-0.000,0.857) tcp=(-0.417,-0.000,0.872) tcp_src=joint_state_chain | Ajustar frescura de pose y no ocultar la discrepancia frente a follow_tcp | Vigente / parcialmente mitigado |
| `stale_tcp_pose_soft_follow` degrada carry | Warnings de stale y carry_follow_lost | Pose TCP demasiado vieja respecto a max_pose_age=1.5 | Log stale: no localizado | Se elevó max pose age en wrapper runtime, pero sigue siendo riesgo abierto | Vigente / riesgo abierto |
...
| `object_not_updated` / `best_obj_move=0` | Confirmar `/gripper/pick_demo/state`, `demo_transport_set_pose_ok` y si el objeto sigue sobre la mesa. Si nunca abandona la mesa, el attach fue sólo lógico. | No localizado en logs inspeccionados |
| `carry_follow_lost` / `best_lift_delta < 0` | Comparar pose objeto vs TCP durante LIFT/CARRY y buscar `stale_tcp_pose_soft_follow` y `world_locked` retrasado. | No localizado en logs inspeccionados |
| `best_tcp_dist > máximo` | El objeto se mueve, pero no acompaña al TCP. Verificar offset ancla, follow mode, frescura de pose y thresholds reales de carry. | [gripper_attach_backend-11] [INFO] [1776911919.046005920] [gripper_attach_backend]: [ATTACH_BACKEND] demo_transport_follow_tick object=pick_demo mode=world_locked desired=(-0.414,-0.000,0.857) tcp=(-0.417,-0.000,0.872) tcp_src=joint_state_chain |
| `stale_tcp_pose_soft_follow` | Inspeccionar `/world/ur5_mesa_objetos/pose/info`, TF freshness y valores `ATTACH_BACKEND_MAX_POSE_AGE_SEC` launch=1.5 / wrapper=2.5. | No localizado en logs inspeccionados |
...
- Geometría visual SDF actual confirmada: `ur5_hand_joint relative_to=tool0, pose=0 0 0 0 0 0`.
- `pick_demo_anchor` runtime actual: 0 0 0.175 sobre `tool0`, sin offsets legacy intermedios.
- Backend actual: modo launch `follow_tcp`, pero `pick_demo` en `pick_demo` usa `world_locked` en demo transport.
- Validación carry post-grasp real: timeout=legacy refactorizados, min_obj_move=legacy refactorizado, min_lift_delta=legacy refactorizado, max_tcp_dist=legacy refactorizado.
...
- `report/BaseDeConocimiento/.tmp_base_conocimiento_2026-05-10/fuentes_verificadas.txt`
- `report/BaseDeConocimiento/.tmp_base_conocimiento_2026-05-10`
...
|---|---|---|---|---|---|---|
| PANEL_PICK_DEMO_GRASP_DOWN_DISABLE_PERMISSIVE_FALLBACK | - | 0 | - | - | override runtime activo | sin discrepancia relevante |
| PANEL_PICK_DEMO_GRASP_DOWN_IK_ERR_TOL | - | 0.200 | - | - | override runtime activo | sin discrepancia relevante |
| PANEL_PICK_DEMO_GRASP_DOWN_IK_SEED_WEIGHT | - | 0.035 | - | 0.65 | discrepancia abierta | histórico=0.65 |
| PANEL_PICK_DEMO_GRASP_DOWN_KEEP_XY_TOL_M | - | 0.015 | - | 0.003 | discrepancia abierta | histórico=0.003 |
| PANEL_PICK_DEMO_GRASP_DOWN_PERMISSIVE_SEED_WEIGHT | - | 0.035 | - | - | override runtime activo | sin discrepancia relevante |
| PANEL_PICK_DEMO_GRASP_DOWN_STRICT_DIST_TOL_M | - | 0.025 | - | 0.012 | discrepancia abierta | histórico=0.012 |
| PANEL_PICK_DEMO_GRASP_DOWN_STRICT_Z_TOL_M | - | 0.025 | - | 0.008 | discrepancia abierta | histórico=0.008 |
| PANEL_PICK_DEMO_GRASP_DOWN_UTIL_Z_ERR_TOL_M | - | 0.025 | - | - | override runtime activo | sin discrepancia relevante |

#### GRASP_ALIGN_IK

| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado | Discrepancia |
|---|---|---|---|---|---|---|
| PANEL_PICK_DEMO_ALIGN_EXIT_XY_TOL_M | - | 0.020 | - | 0.010 | discrepancia abierta | histórico=0.010 |
| PANEL_PICK_DEMO_ALIGN_IK_ERR_TOL | - | 0.200 | - | 0.08 | discrepancia abierta | histórico=0.08 |
...
| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado | Discrepancia |
|---|---|---|---|---|---|---|
| PANEL_PICK_DEMO_PRE_CLOSE_XY_TOL_M | - | 0.016 | - | 0.010 | discrepancia abierta | histórico=0.010 |

#### CLOSE

| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado | Discrepancia |
|---|---|---|---|---|---|---|
| PANEL_PICK_DEMO_CLOSE_CONFIRM_TIMEOUT_SEC | - | 120 | - | 3.0 | discrepancia abierta | histórico=3.0 |

#### ATTACH_GATE

| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado | Discrepancia |
|---|---|---|---|---|---|---|
| PANEL_PICK_DEMO_ATTACH_FOLLOW_MAX_TCP_DIST_M | - | 0.080 | - | 0.040 | discrepancia abierta | histórico=0.040 |
| PANEL_PICK_DEMO_ATTACH_MAX_REL_DRIFT_M | - | 0.050 | - | 0.012 | discrepancia abierta | histórico=0.012 |
| PANEL_PICK_DEMO_ATTACH_MIN_STABLE_SAMPLES | - | 3 | - | 5 | discrepancia abierta | histórico=5 |
| PANEL_PICK_DEMO_ATTACH_SETTLE_SEC | - | 4.0 | - | - | override runtime activo | sin discrepancia relevante |
| PANEL_PICK_DEMO_ATTACH_STABLE_WINDOW_SEC | - | 0.25 | - | 0.35 | discrepancia abierta | histórico=0.35 |
| PANEL_PICK_DEMO_ATTACH_XY_TOL_M | - | 0.020 | - | 0.008 | discrepancia abierta | histórico=0.008 |

#### LIFT / CARRY

| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado | Discrepancia |
|---|---|---|---|---|---|---|
| PANEL_PICK_DEMO_CARRY_HOME_MAX_TCP_DIST_M | - | 0.500 | - | - | override runtime activo | sin discrepancia relevante |

#### freshness / pose source

| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado | Discrepancia |
|---|---|---|---|---|---|---|
| PANEL_PICK_DEMO_POSE_SOURCE_AGE_TOL_SEC | - | 300.0 | - | 0.400 | discrepancia abierta | histórico=0.400 |
| PANEL_PICK_DEMO_POSE_SOURCE_SYNC_TOL_SEC | - | 300.0 | - | - | override runtime activo | sin discrepancia relevante |
| PANEL_PICK_DEMO_POSE_SOURCE_TOL_M | - | 1.0 | - | 0.006 | discrepancia abierta | histórico=0.006 |
...
| ATTACH_BACKEND_FOLLOW_BREAK_DIST_M | - | 0.45 | - | - | override runtime activo | sin discrepancia relevante |
| ATTACH_BACKEND_FOLLOW_RATE_HZ | - | 10.0 | - | - | override runtime activo | sin discrepancia relevante |
| ATTACH_BACKEND_MAX_DIST_M | - | 0.06 | - | 0.06 | override runtime activo | sin discrepancia relevante |
| ATTACH_BACKEND_MAX_POSE_AGE_SEC | - | 2.5 | - | - | override runtime activo | sin discrepancia relevante |
| ATTACH_BACKEND_MODE | - | follow_tcp | - | - | override runtime activo | sin discrepancia relevante |
...
| PANEL_PICK_DEMO_STEP_TIMEOUT_EXTRA_SEC | - | 60 | - | - | override runtime activo | sin discrepancia relevante |
