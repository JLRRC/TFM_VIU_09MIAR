...
|---|---|---|---|---|---|
| GRASP_CONTACT_Z_OFFSET_M | 0.0 | - | 0.0 | 0.13 | discrepancia abierta |
...
| PANEL_PICK_DEMO_DIRECT_IK_TCP_OFFSET_M | - | 0.175 | - | - | override runtime activo |
| PANEL_PICK_DEMO_GRASP_DOWN_IK_ERR_TOL | 0.200 | - | 0.080 | - | discrepancia abierta |
| PANEL_PICK_DEMO_GRASP_DOWN_IK_SEED_WEIGHT | 0.035 | - | 0.65 | 0.65 | discrepancia abierta |
...
| PANEL_PICK_DEMO_PRE_CLOSE_XY_TOL_M | 0.020 | - | - | 0.010 | discrepancia abierta |
...
| PANEL_PICK_DEMO_ATTACH_FOLLOW_MAX_TCP_DIST_M | 0.040 | - | 0.040 | 0.040 | default launch |
| PANEL_PICK_DEMO_ATTACH_MAX_REL_DRIFT_M | 0.012 | - | 0.012 | 0.012 | default launch |
| PANEL_PICK_DEMO_ATTACH_MIN_STABLE_SAMPLES | 5 | - | 5 | 5 | default launch |
| PANEL_PICK_DEMO_ATTACH_STABLE_WINDOW_SEC | 0.35 | - | 0.35 | 0.35 | default launch |
| PANEL_PICK_DEMO_ATTACH_XY_TOL_M | 0.020 | - | 0.012 | 0.008 | discrepancia abierta |
| PANEL_PICK_DEMO_ATTACH_Z_TOL_M | 0.010 | - | 0.015 | 0.010 | discrepancia abierta |
| PANEL_PICK_DEMO_CARRY_HOME_MAX_TCP_DIST_M | - | - | 0.200 | - | fallback local panel |
| PANEL_PICK_DEMO_CARRY_SETTLE_SEC | - | - | 3.0 | - | fallback local panel |
| PANEL_PICK_DEMO_CLOSE_CONFIRM_TIMEOUT_SEC | 3.0 | - | - | 3.0 | default launch |
...
| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado |
|---|---|---|---|---|---|
| PANEL_MOVEIT_BRIDGE_ACCEL_SCALE | - | 0.30 | - | 0.30 | override runtime activo |
...
| PANEL_MOVEIT_BRIDGE_VELOCITY_SCALE | - | 0.30 | - | 0.30 | override runtime activo |
...
| PANEL_PICK_DEMO_PHASE_JUMP_TOL_M | 0.010 | - | 0.010 | 0.010 | default launch |
| PANEL_PICK_DEMO_POSE_SOURCE_AGE_TOL_SEC | 0.400 | - | 0.20 | 0.400 | discrepancia abierta |
| PANEL_PICK_DEMO_POSE_SOURCE_TOL_M | 0.006 | - | 0.006 | 0.006 | default launch |
...
| GRASP_CONTACT_Z_OFFSET_M | geometría y altura de agarre | 0.0 | - | 0.0 | 0.13 | histórico=0.13 |
...
| PANEL_PICK_DEMO_ATTACH_XY_TOL_M | ATTACH_GATE | 0.020 | - | 0.012 | 0.008 | actual difiere entre fuentes; histórico=0.008; panel usa fallback distinto |
...
| PANEL_PICK_DEMO_GRASP_DOWN_IK_ERR_TOL | GRASP_DOWN | 0.200 | - | 0.080 | - | actual difiere entre fuentes; panel usa fallback distinto |
| PANEL_PICK_DEMO_GRASP_DOWN_IK_SEED_WEIGHT | GRASP_DOWN | 0.035 | - | 0.65 | 0.65 | actual difiere entre fuentes; panel usa fallback distinto |
| PANEL_PICK_DEMO_GRASP_DOWN_KEEP_XY_TOL_M | GRASP_DOWN | 0.005 | - | 0.005 | 0.003 | histórico=0.003 |
...
| PANEL_PICK_DEMO_POSE_SOURCE_AGE_TOL_SEC | freshness / pose source | 0.400 | - | 0.20 | 0.400 | actual difiere entre fuentes; panel usa fallback distinto |
| PANEL_PICK_DEMO_PRE_CLOSE_XY_TOL_M | PRE_CLOSE | 0.020 | - | - | 0.010 | histórico=0.010 |
...
|---|---|---|---|---|---|---|
| GRASP_CONTACT_Z_OFFSET_M | 0.0 | - | 0.0 | 0.13 | discrepancia abierta | histórico=0.13 |
| PANEL_PICK_DEMO_DIRECT_IK_TCP_OFFSET_M | - | 0.175 | - | - | override runtime activo | sin discrepancia relevante |
...
| PANEL_PICK_DEMO_APPROACH_COARSE_GATE_XY_TOL_M | 0.012 | - | 0.012 | 0.012 | default launch | sin discrepancia relevante |
| PANEL_PICK_DEMO_APPROACH_COARSE_GATE_Z_TOL_M | 0.012 | - | 0.012 | 0.012 | default launch | sin discrepancia relevante |
...
| PANEL_PICK_DEMO_GRASP_DOWN_DISABLE_PERMISSIVE_FALLBACK | 1 | - | - | - | default launch | sin discrepancia relevante |
| PANEL_PICK_DEMO_GRASP_DOWN_FORCE_INHERIT_XY | 1 | - | - | - | default launch | sin discrepancia relevante |
| PANEL_PICK_DEMO_GRASP_DOWN_IK_ERR_TOL | 0.200 | - | 0.080 | - | discrepancia abierta | actual difiere entre fuentes; panel usa fallback distinto |
| PANEL_PICK_DEMO_GRASP_DOWN_IK_SEED_WEIGHT | 0.035 | - | 0.65 | 0.65 | discrepancia abierta | actual difiere entre fuentes; panel usa fallback distinto |
| PANEL_PICK_DEMO_GRASP_DOWN_KEEP_XY_TOL_M | 0.005 | - | 0.005 | 0.003 | discrepancia abierta | histórico=0.003 |
...
| PANEL_PICK_DEMO_GRASP_DOWN_UTIL_Z_ERR_TOL_M | - | - | 0.025 | - | fallback local panel | sin discrepancia relevante |
...
| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado | Discrepancia |
|---|---|---|---|---|---|---|
| PANEL_PICK_DEMO_PRE_CLOSE_XY_TOL_M | 0.020 | - | - | 0.010 | discrepancia abierta | histórico=0.010 |
...
| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado | Discrepancia |
|---|---|---|---|---|---|---|
| PANEL_PICK_DEMO_CLOSE_CONFIRM_TIMEOUT_SEC | 3.0 | - | - | 3.0 | default launch | sin discrepancia relevante |
...
| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado | Discrepancia |
|---|---|---|---|---|---|---|
| PANEL_PICK_DEMO_ATTACH_FOLLOW_MAX_TCP_DIST_M | 0.040 | - | 0.040 | 0.040 | default launch | sin discrepancia relevante |
| PANEL_PICK_DEMO_ATTACH_MAX_REL_DRIFT_M | 0.012 | - | 0.012 | 0.012 | default launch | sin discrepancia relevante |
| PANEL_PICK_DEMO_ATTACH_MAX_TF_VISUAL_GAP_M | 0.020 | - | 0.020 | 0.020 | default launch | sin discrepancia relevante |
| PANEL_PICK_DEMO_ATTACH_MIN_STABLE_SAMPLES | 5 | - | 5 | 5 | default launch | sin discrepancia relevante |
| PANEL_PICK_DEMO_ATTACH_SETTLE_SEC | - | - | 1.8 | - | fallback local panel | sin discrepancia relevante |
| PANEL_PICK_DEMO_ATTACH_STABLE_WINDOW_SEC | 0.35 | - | 0.35 | 0.35 | default launch | sin discrepancia relevante |
| PANEL_PICK_DEMO_ATTACH_XY_TOL_M | 0.020 | - | 0.012 | 0.008 | discrepancia abierta | actual difiere entre fuentes; histórico=0.008; panel usa fallback distinto |
...
| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado | Discrepancia |
|---|---|---|---|---|---|---|
| PANEL_PICK_DEMO_CARRY_HOME_MAX_TCP_DIST_M | - | - | 0.200 | - | fallback local panel | sin discrepancia relevante |
...
| PANEL_PICK_DEMO_POSE_SOURCE_AGE_TOL_SEC | 0.400 | - | 0.20 | 0.400 | discrepancia abierta | actual difiere entre fuentes; panel usa fallback distinto |
| PANEL_PICK_DEMO_POSE_SOURCE_SYNC_TOL_SEC | - | - | 0.20 | - | fallback local panel | sin discrepancia relevante |
| PANEL_PICK_DEMO_POSE_SOURCE_TOL_M | 0.006 | - | 0.006 | 0.006 | default launch | sin discrepancia relevante |
...
| Variable | Launch | Runtime wrapper | Fallback panel | Histórico | Estado | Discrepancia |
|---|---|---|---|---|---|---|
| PANEL_MOVEIT_BRIDGE_ACCEL_SCALE | - | 0.30 | - | 0.30 | override runtime activo | sin discrepancia relevante |
...
| PANEL_MOVEIT_BRIDGE_VELOCITY_SCALE | - | 0.30 | - | 0.30 | override runtime activo | sin discrepancia relevante |
...
| PANEL_PICK_DEMO_IK_SEED_JOINTS | - | - | - | - | alineado | sin discrepancia relevante |
| PANEL_PICK_DEMO_PHASE_JUMP_TOL_M | 0.010 | - | 0.010 | 0.010 | default launch | sin discrepancia relevante |
| PANEL_PICK_DEMO_PICK_IMAGE_SETTLE_SEC | - | - | 3.0 | - | fallback local panel | sin discrepancia relevante |
| PANEL_PICK_DEMO_PICK_IMAGE_TCP_TOL_M | - | - | 0.030 | - | fallback local panel | sin discrepancia relevante |
...
| PANEL_PICK_DEMO_STEP_TIMEOUT_EXTRA_SEC | - | - | 0 | - | fallback local panel | sin discrepancia relevante |
